...
def get_db_connection():
    """Create a MySQL connection using values from the .env file."""
...
def initialize_database():
    ...
    try:
        ...
        cursor.execute("ALTER TABLE group_members ADD COLUMN role ENUM('admin', 'moderator', 'member') DEFAULT 'member'")
        
        # Insert default channels for existing groups if they don't exist
        cursor.execute("""
            INSERT IGNORE INTO channels (group_id, channel_name, description) VALUES
...
# Mock Authentication for Testing (No OAuth Required)
# Comment this out and uncomment OAuth section below when you have credentials


def get_current_user():
    """Fetch the currently logged in user from session and MySQL."""
